...
node {
    ...
    stage("Create Folder"){
        ...
        def create =def path = sh(script: "curl -X POST  http://18.232.144.156:8080/job/CreateJob/createItem?name=SmokeTest   -u admin:111f188371615e4779b9598eb94c5c0f16 -H Content-Type:application/xml -d @configFolder.xml", returnStdout: false)
